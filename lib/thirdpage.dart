...
//        child :  new Center(
//          child: new Icon(Icons.beach_access, size:150.0 , color: Colors.black)
//        )
//      );
//    }
...
class ThirdPage extends StatefulWidget{
  @override
   _ThirdPage createState(){
     return _ThirdPage();

   }
  }
  
  class _ThirdPage extends State<ThirdPage> with AutomaticKeepAliveClientMixin<ThirdPage>{
    ...
    viewmovies()async{
      ...
      var output =  await http.get('https://api.themoviedb.org/3/movie/now_playing?api_key=578152be1392218f6d775ceb67b4e4f6&language=en-US&page=3');
   print(output);
